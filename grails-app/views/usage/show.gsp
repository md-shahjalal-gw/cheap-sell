...
<html>
    ...
    <body>
        ...
        <div id="show-usage" class="content scaffold-show" role="main">
            ...
            <f:display bean="usage" />
            <g:form resource="${this.usage}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.usage}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
