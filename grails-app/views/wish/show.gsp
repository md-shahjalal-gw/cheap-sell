    ...
    <body>
        ...
        <div id="show-wish" class="content scaffold-show" role="main">
            ...
            <div class="fieldcontain required">
                <label>Name:</label>${wish?.name}
            </div>
            <div class="fieldcontain required">
                <label>Description:</label>${wish?.description}
            </div>
            <div class="fieldcontain required">
                <label>Price:</label>${wish?.price}
            </div>
            <g:form resource="${this.wish}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.wish}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
