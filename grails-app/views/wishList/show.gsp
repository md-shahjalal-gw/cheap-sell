...
<html>
    ...
    <body>
        ...
        <div id="show-wishList" class="content scaffold-show" role="main">
            ...
            <f:display bean="wishList" />
            <g:form resource="${this.wishList}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.wishList}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
