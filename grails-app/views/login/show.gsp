...
<html>
    ...
    <body>
        ...
        <div id="show-login" class="content scaffold-show" role="main">
            ...
            <f:display bean="login" />
            <g:form resource="${this.login}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.login}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
