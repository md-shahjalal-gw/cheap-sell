...
class gsp_cheap_sell_contactedit_gsp extends org.grails.gsp.GroovyPage {
...
invokeTag('eachError','g',26,['bean':(this.contact),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',28,['bean':(this.contact)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',30,['name':("version"),'value':(this.contact?.version)],-1)
printHtmlPart(21)
invokeTag('all','f',32,['bean':("contact")],-1)
printHtmlPart(22)
expressionOut.print(message(code: 'default.button.update.label', default: 'Update'))
printHtmlPart(23)
})
invokeTag('form','g',37,['resource':(this.contact),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1571609097000L
