...
class gsp_cheap_sell_itemedit_gsp extends org.grails.gsp.GroovyPage {
...
invokeTag('eachError','g',26,['bean':(this.item),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',28,['bean':(this.item)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',30,['name':("version"),'value':(this.item?.version)],-1)
printHtmlPart(21)
invokeTag('all','f',32,['bean':("item")],-1)
printHtmlPart(22)
expressionOut.print(message(code: 'default.button.update.label', default: 'Update'))
printHtmlPart(23)
})
invokeTag('form','g',37,['resource':(this.item),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1571579385000L
