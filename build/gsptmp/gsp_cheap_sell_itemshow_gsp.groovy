...
class gsp_cheap_sell_itemshow_gsp extends org.grails.gsp.GroovyPage {
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("item")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.item)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.item),'method':("DELETE")],2)
printHtmlPart(17)
})
