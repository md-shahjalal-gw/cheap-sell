...
class gsp_cheap_sell_itemindex_gsp extends org.grails.gsp.GroovyPage {
...
printHtmlPart(4)
expressionOut.print(createLink(uri: '/home/index'))
printHtmlPart(5)
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(itemList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(itemCount ?: 0)],-1)
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1572311086000L
