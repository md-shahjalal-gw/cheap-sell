...
class gsp_cheap_sell_wishListindex_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/wishList/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(wishListList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(wishListCount ?: 0)],-1)
printHtmlPart(13)
})
