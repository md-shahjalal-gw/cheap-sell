...
class gsp_cheap_sell_contactcreate_gsp extends org.grails.gsp.GroovyPage {
...
invokeTag('eachError','g',25,['bean':(this.contact),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(this.contact)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('all','f',30,['bean':("contact")],-1)
printHtmlPart(20)
invokeTag('submitButton','g',33,['name':("create"),'class':("save"),'value':(message(code: 'default.button.create.label', default: 'Create'))],-1)
printHtmlPart(21)
})
invokeTag('form','g',35,['resource':(this.contact),'method':("POST")],2)
printHtmlPart(22)
})
