...
class gsp_cheap_sell_userProfileTypeindex_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/userProfileType/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(userProfileTypeList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(userProfileTypeCount ?: 0)],-1)
printHtmlPart(13)
})
