...
class gsp_cheap_sell_usercreate_gsp extends org.grails.gsp.GroovyPage {
...
invokeTag('form','g',35,['resource':(this.user),'method':("POST")],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1571610468000L
