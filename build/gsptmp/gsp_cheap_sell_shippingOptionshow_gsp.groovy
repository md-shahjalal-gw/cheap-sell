...
class gsp_cheap_sell_shippingOptionshow_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/shippingOption/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("shippingOption")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.shippingOption)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.shippingOption),'method':("DELETE")],2)
printHtmlPart(17)
})
